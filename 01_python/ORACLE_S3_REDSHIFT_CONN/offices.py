...
#         query = f"""
#         SELECT OFFICECODE, CITY, PHONE, ADDRESSLINE1, ADDRESSLINE2, STATE, COUNTRY, POSTALCODE, TERRITORY, CREATE_TIMESTAMP, UPDATE_TIMESTAMP
#         FROM {table_name}@dblink
#         WHERE UPDATE_TIMESTAMP >= :etl_batch_date
#         """
...
tables = 'OFFICES'
headers = "officeCode,city,phone,addressLine1,addressLine2,state,country,postalCode,territory,create_timestamp,update_timestamp"
