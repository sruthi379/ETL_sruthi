...
# #         QUANTITYINSTOCK, BUYPRICE, MSRP, CREATE_TIMESTAMP, UPDATE_TIMESTAMP
...
# # export_table('PRODUCTS', 'PRODUCTS')
...
tables = 'PRODUCTS'
headers = "productCode,productName,productLine,productScale,productVendor,quantityInStock,buyPrice,MSRP,create_timestamp,update_timestamp"
