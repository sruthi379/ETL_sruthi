...
# # export_table('PAYMENTS', 'PAYMENTS')
...
#         query = f"""
#         SELECT CUSTOMERNUMBER, CHECKNUMBER, PAYMENTDATE, AMOUNT, CREATE_TIMESTAMP, UPDATE_TIMESTAMP
#         FROM {table_name}@dblink
#         WHERE UPDATE_TIMESTAMP >= :etl_batch_date
#         """
...
tables = 'PAYMENTS'
headers = "customerNumber,checkNumber,paymentDate,amount,create_timestamp,update_timestamp"
