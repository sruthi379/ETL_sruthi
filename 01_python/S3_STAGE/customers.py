...
def load_data_to_redshift(table_name, s3_folder, etl_batch_date):
    ...
    try:
        ...
        COPY devstage.{table_name}  (CUSTOMERNUMBER,CUSTOMERNAME,CONTACTLASTNAME,CONTACTFIRSTNAME,PHONE,ADDRESSLINE1,ADDRESSLINE2,CITY,STATE,POSTALCODE,COUNTRY,SALESREPEMPLOYEENUMBER,CREDITLIMIT,CREATE_TIMESTAMP,UPDATE_TIMESTAMP) 
        FROM '{s3_key}'
